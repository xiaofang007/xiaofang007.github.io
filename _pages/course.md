...
IEDA2010    3   Industrial Engineering and Decision Analytics  
LANG1002S   3   English for University Studies I  
MATH1013    3   Calculus IB  
```
### Winter
```angular2html
COMP1029C   1   C Programming Bridging Course  
```
### Spring
```angular2html
...
MATH2011    3   Introduction to Multivariable Calculus  
...
### Spring
```angular2html
COMP2211    3   Exploring Artificial Intelligence  
...
MATH3425    3   Stochastic Modeling  
UROP1100    1   Undergraduate Research Opportunities Series 1  
```
### Summer
```angular2html
COMP4971A   1   Independent Work
```
## UG Year 3
### Fall
```angular2html
...
ELEC3120    3   Computer Communication Networks  
...
### Spring at EPFL
```angular2html
CS-206      4   Parallelism and concurrency  
CS-322      4   Introduction to database systems  
CS-442      4   Computer vision  
COM-405     4   Mobile networks  
```